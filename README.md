...
2. Download and install GO https://golang.org/dl/ (Should include instructions on their page) (This is temporary until we get executables packaged for systems
