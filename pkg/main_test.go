...
func TestParse(t *testing.T) {
	...
	slideshow := slideshow.NewSlideshow(templateName)
	...
	if expectedBackAudioPath != slideshow.BackAudioPath {
		t.Error(fmt.Sprintf("expected audio filename to be %s, but got %s", expectedBackAudioPath, slideshow.BackAudioPath))
	}

	expectedBackAudioVolume := ""
	if expectedBackAudioVolume != slideshow.BackAudioVolume {
		t.Error(fmt.Sprintf("expected audio filename to be %s, but got %s", expectedBackAudioVolume, slideshow.BackAudioVolume))
	}
